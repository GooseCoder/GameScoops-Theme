...
For more information please visit http://www.GameScoops.com/?p=help_drupal
...
3. Copy or upload theme files exported from GameScoops into the newly created <MyNewTheme> folder.
...
*** Utilizing Menus
---------------------------------------
Please use the following steps to utilize menu style designed with GameScoops: 
