...
function GameScoopsNew_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function GameScoopsNew_button($variables) {
 ...
 */
function GameScoopsNew_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function GameScoopsNew_menu_local_task($variables) {
 ...
 */
function GameScoopsNew_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function GameScoopsNew_node_preview($variables) {
  $node = $variables['node'];
