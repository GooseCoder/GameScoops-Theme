...
function GameScoopsNew_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function GameScoopsNew_feed_icon($url, $title) {
 ...
 */
function GameScoopsNew_preprocess_comment_wrapper(&$vars) {
 ...
 */
function GameScoopsNew_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function GameScoopsNew_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function GameScoopsNew_button($element) {
 ...
 * @ingroup themeable
 */
function GameScoopsNew_node_preview($node) {
