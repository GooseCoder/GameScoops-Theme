...
function GameScoopsNew_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function GameScoopsNew_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function GameScoopsNew_feed_icon($url) {
 ...
 */
function GameScoopsNew_comment_wrapper($content, $type = null) {
  static $node_type;
